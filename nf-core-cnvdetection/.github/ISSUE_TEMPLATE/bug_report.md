...
<!--
# nf-core/cnvdetection bug report
...
- [ ] [nf-core/cnvdetection pipeline documentation](https://nf-co.re/nf-core/cnvdetection/usage)
...
- version: <!-- [e.g. 1.0.0] -->
- Image tag: <!-- [e.g. nfcore/cnvdetection:1.0.0] -->
